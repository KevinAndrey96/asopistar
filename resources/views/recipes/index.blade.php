...
<div class="container">
    ...
    <a href="{{ url('recipes/create') }}" class="btn btn-success" > Crear Receta</a>
    <br/>
    <br/>
    <table id= "my_table" class="table table-light">
        ...
        <tbody>
            ...
            <tr>
                ...
                <a href="{{ url('/recipes/'.$recipe->id.'/edit') }}" class="btn btn-warning">
                	<span class="nav-icon">
                ...
                <form action="{{ url('/recipes/'.$recipe->id ) }}" class="d-inline" method="post">
                    @csrf
                    {{ method_field('DELETE') }}
