	    ...
	    <div class="col-12 col-md-7 col-lg-6 auth-main-col text-center p-5">
		    <div class="d-flex flex-column align-content-end">
			    <div class="app-auth-body mx-auto">	
				    <div class="app-auth-branding mb-4"><img class="logo-icon me-2" src="assets/images/app-logo.png" alt="logo" width="50%" height="50%"></div>
					<h2 class="auth-heading text-center mb-5">{{ __('Iniciar Sesión') }}</h2>
