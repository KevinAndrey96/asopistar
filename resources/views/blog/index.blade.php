...
<div class="container">
    ...
    <a href="{{ url('blog/create') }}" class="btn btn-success" > Crear Blog </a>
    <br/>
    <br/>
    <table id= "my_table" class="table table-light">
        ...
        <tbody>
            ...
            <tr>
                ...
                <a href="{{ url('/blog/'.$blog->id.'/edit') }}" class="btn btn-warning">
                	<span class="nav-icon">
                ...
                <form action="{{ url('/blog/'.$blog->id ) }}" class="d-inline" method="post">
                    @csrf
                    {{ method_field('DELETE') }}
