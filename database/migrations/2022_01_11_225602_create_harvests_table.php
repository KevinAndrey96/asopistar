...
class CreateHarvestsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('harvests', function (Blueprint $table) {
            ...
            $table->bigInteger('pond_id')->unsigned();//$table->string('pond_code');
            $table->string('species');//lista de los alevines
            $table->double('amount');//peso total
            $table->integer('fish_number');//nummero de peces
            $table->double('average_weight');//lo calcula con amount/fish_number
